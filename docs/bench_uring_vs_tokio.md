...
- Backend selection: `LURE_IO_URING=0` vs `LURE_IO_URING=1`
...
LURE_IO_URING=1 cargo run --bin bench_proxy --release -- --duration 15 --warmup 5 --concurrency 32 --payload 1024
```
